...
function FeedbackForm({ send }) {
  ...
  function allIsValid() {
    return fname && lname && email && isValidFirstorLastName(fname) && isValidFirstorLastName(lname) && isValidEmail(email) && phone && isValidPhone(phone) && postcode && isValidPostcode(postcode) && feedback
  }
      ...
      <Grid container spacing={3} className="feedback-form">
        ...
        <Grid item xs={12} sm={6}>
          <TextField 
            ...
            name="firstname"
            label="First name"
            error={!!fname && !isValidFirstorLastName(fname)}
        ...
        <Grid item xs={12} sm={6}>
          <TextField 
            ...
            name="lastname"
            label="Last name"
            error={!!lname && !isValidFirstorLastName(lname)}
